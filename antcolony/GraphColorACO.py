...
class GraphColorACO:
    ...
    def updatePheroMat(self) -> None:
        '''
        This method updates the pheromone matrix based on the colorings generated by the ants. 
        The pheromone on each edge is reduced by the evaporation rate, and then increased by the amount of pheromone deposited by the ants.
        '''
